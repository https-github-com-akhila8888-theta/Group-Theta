        ...
        try:
            ...
            while queue_data.empty() == 0:
                ...
                if message[0] == 'register':
                    ...
                    if len(message)!=3:
                        try:
                            new_msg = 'Error occured in syntax of login data It must login user_name password'
                            new_msg = new_msg.encode()
                            writer.write(new_msg + '\n'.encode())
                    ...
                    if len(message)!=2:
                        try:
                            new_msg = 'Error occured in the format of create_folder It must be create_folder and Folder_name'
                            new_msg = new_msg.encode()
                            writer.write(new_msg + '\n'.encode())
                        except:
                            pass
                    ...
                    if(len(message)!=2):
                        try:
                            new_msg = 'Error occured in the format of read_file It must be read_file and file_name'
                            new_msg = new_msg.encode()
                            writer.write(new_msg + '\n'.encode())
                        except:
                            pass
